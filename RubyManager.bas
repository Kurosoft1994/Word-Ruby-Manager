' =================================================================
' Ruby Manager System for Word VBA (v1.0.0 First Release)
' 
' 【機能概要】
' ・ルビ追加・削除の統合コントロール（全部 / ページ単位 / 段落単位）
' ・対話型コンテキストヘルプ対応（「?」入力で解説表示）
' ・設定および単語辞書の自動保存・読み込み（ruby_config.ini）
' =================================================================
